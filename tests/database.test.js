...
const { storeTweetsToSupabase, getTweetsFromSupabase } = require('../lib/database');
...
describe('Database Functions', () => {
  ...
  describe('storeTweetsToSupabase', () => {
    ...
    it('should throw error when Supabase returns error', async () => {
      ...
      // Act & Assert
      await expect(storeTweetsToSupabase(mockTweets)).rejects.toThrow('Database error');
    });
  });
  ...
  describe('getTweetsFromSupabase', () => {
    ...
    it('should throw error when Supabase returns error', async () => {
      ...
      // Act & Assert
      await expect(getTweetsFromSupabase(10)).rejects.toThrow('Database connection failed');
    });
